...
## 📦 AdBlock Rules — 2026-05-12 23:17 CST
...
### 📥 订阅源明细
  ...
  - `https://anti-ad.net/adguard.txt` → 解析出 **97054** 个域名
  - `https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_11_Mobile/filter.txt` → 解析出 **919** 个域名
  - `https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_15_DnsFilter/filter.txt` → 解析出 **146055** 个域名
